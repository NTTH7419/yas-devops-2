...
```shell
helm repo add yas https://ntth7419.github.io/yas-devops-2
```
...
```
View detail charts [Yas Helm Charts](https://github.com/NTTH7419/yas-devops-2/tree/main/charts)

Config for Yas Spring boot microservies on [yas-configuration](https://github.com/NTTH7419/yas-devops-2/tree/main/charts/yas-configuration)